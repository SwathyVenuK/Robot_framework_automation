...
Verify WebPage title
    ...
    Log to Console  Pass!!
Buy a book
    Click Element  ${Amazon}
    Log to console  Step7

Add to cart
     Select window  Buy RESTful Web Services Cookbook Book Online at Low Prices in India | RESTful Web Services Cookbook Reviews & Ratings - Amazon.in
     ${url1} =  get Location
     log to console  ${url1}
